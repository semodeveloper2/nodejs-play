...
array1 = regex1.exec(str1);
console.log("Found ".concat(array1[0], ". Next starts at ").concat(regex1.lastIndex, "."));
array1 = regex1.exec(str1);
console.log("Found ".concat(array1[0], ". Next starts at ").concat(regex1.lastIndex, "."));
console.log(regex1, array1[0].length);
console.log(str1[regex1.lastIndex - array1[0].length], str1[regex1.lastIndex - 1]);
